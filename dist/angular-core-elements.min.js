...
}}(this)}).directive("coreContentTab",[function(){return{scope:{name:"@",active:"=?"},restrict:"E",require:"^coreContentTabs",link:function(a,b,c,d){if(null==a.name)throw new Error("name should be defined");return null==a.active&&(a.active=!1),d.add(a.name,a.active,b.html()),b.remove()}}}])}(window.angular);